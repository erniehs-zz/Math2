...
describe("Math2 is a static library of useful functions", function () {
    ...
    describe("Math2 has betweenEx, exclusive of boundary", function () {
        it("can test that a number is between two other numbers", function () {
            expect(Math2.betweenEx(1, -10, 10)).to.be.true;
            expect(Math2.betweenEx(-9, -10, 10)).to.be.true;
            expect(Math2.betweenEx(9, -10, 10)).to.be.true;
            expect(Math2.betweenEx(2, -10, 10)).to.be.true;
            expect(Math2.betweenEx(5, -10, 10)).to.be.true;
            expect(Math2.betweenEx(0, -10, 10)).to.be.true;
        });
        it("can test that a number is not between two other numbers", function () {
            expect(Math2.betweenEx(10, -10, 10)).to.be.false;
            expect(Math2.betweenEx(-11, -10, 10)).to.be.false;
            expect(Math2.betweenEx(-10, -10, 10)).to.be.false;
            expect(Math2.betweenEx(12, -10, 10)).to.be.false;
            expect(Math2.betweenEx(50, -10, 10)).to.be.false;
            expect(Math2.betweenEx(-10.1, -10, 10)).to.be.false;
        });
    });
});
